...
#  Default: 'chriswoodall'
# c.Session.username = 'chriswoodall'
...
#  Choices: any of ['sha512', 'sha224', 'sha256', 'sha3_256', 'sha3_512', 'blake2b', 'sha1', 'sha384', 'blake2s', 'md5', 'sha3_224', 'sha3_384']
#  Default: 'sha256'
...
c.JupyterLabTemplates.template_dirs = [f'{str(Path.home())}/data/templates/']
